            ...
            <div class="card text-white bg-secondary mb-3">
                <form action="<c:url value='/topics/save'/>" method='POST'>
                    <div class="form-group row">
                        <label class="col-form-label col-sm-3" for="name" style="padding-left: 30px; font-weight: bold; font-weight: 900">Название темы</label>
                        <div class="col-sm-5">
                            <input type='text' class="form-control" name='name' id="name" value="${topic.name}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-sm-3" for="status" style="padding-left: 30px; font-weight: 900">Статус обсуждения</label>
                        <div class="col-sm-5">
